  ...
  <body>
    <main>
      <div class="centering text-center">
        <h1>Setup LDAP password</h1> 
      </div>
      <br/>
      <div class="row">
        <div class="col-sm-4 col-sm-offset-4">
          <form method="post">
            <input id="username" name="username_show" class="input-lg form-control" value="{{ get('username', '') }}" type="text" disabled>
            <input type="hidden" name="username" class="input-lg form-control" value="{{ get('username', '') }}">

            <input id="new-password" name="new-password" class="input-lg form-control" type="password" placeholder="New Password" required autofocus>
            <div class="row">
              <div class="col-sm-6">
